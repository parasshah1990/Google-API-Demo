...
public class GoogleMailController {
	...
	private static final String APPLICATION_NAME = "RahulAPIOAuthTest";
	...
	public ResponseEntity<String> oauth2Callback(@RequestParam(value = "code") String code) {
		...
		try {
			...
			String userId = "rahul.rabhadiya@highq.com";
	...
	private String authorize() throws Exception {
		...
		if (flow == null) {
			...
			web.setClientId("190247775204-lbo5hj5bgllv367sh8vspecbbvvb6ul2.apps.googleusercontent.com");
			web.setClientSecret("BgV4F09YkdN85Nx1e-eeV9A4");
